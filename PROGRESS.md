...
- **Métricas**: JS total 2.3 KB gzip (modal 1124 B gzip — presupuesto <10 KB cumplido); tests 13/13, lint 0 errores, build OK; grep de email/teléfono (patrón genérico) en src+dist → 0 resultados; sin `mailto:`/`tel:` en componentes
